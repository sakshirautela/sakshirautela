      ...
      <div className="container">
        <div className="about-grid">
          <div className="about-left">
            ...
            <p className="about-text">
              Having solved <strong>1,000+ coding problems</strong> on LeetCode,
              I possess strong foundations in Data Structures & Algorithms and
              enjoy solving complex engineering challenges. I build scalable
              AI-powered applications by combining intelligent models with
              clean software architecture to create impactful, real-world
              solutions.
            </p>
          ...
          <div className="about-right">
            <div className="about-links">
              <a
                href="https://www.linkedin.com/in/sakshi-b1823a349/"
                target="_blank"
                rel="noreferrer"
              ...
              <a
                href="https://github.com/sakshirautela"
                target="_blank"
                rel="noreferrer"
                className="about-link"
              >
              ...
              <a
                href="https://leetcode.com/u/sakshirautela"
                target="_blank"
                rel="noreferrer"
                className="about-link"
              >
              ...
              <a
                href="https://www.geeksforgeeks.org/profile/sakshirautela"
                target="_blank"
                rel="noreferrer"
                className="about-link"
              >
            ...
            <div className="about-card">
              ...
              <div className="about-avatar">
                <div className="avatar-ring" />
                  <img src="./assets/image.png" alt="Sakshi Rautela" />
              </div>
