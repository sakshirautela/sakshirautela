        ...
        <div className="about-grid">
          <div className="about-left">
            ...
            <p className="about-text">
              ...
              & Generative AI. I build <strong>scalable, production-ready backend systems</strong> using Java Spring Boot,
            ...
            <div className="about-links">
              <a href="https://linkedin.com" target="_blank" rel="noreferrer" className="about-link">
              ...
              <a href="https://leetcode.com" target="_blank" rel="noreferrer" className="about-link">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
            ...
            <div className="about-card">
              ...
              <div className="about-info">
                ...
                <div className="info-row">
                  ...
                  <span className="info-val">Noida WFO</span>
                </div>
                <div className="info-row">
